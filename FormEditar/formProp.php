...
<body style="color: white;" class="formalta">
    <form action="../EditarAltas/eaProp.php" method="POST">
        <div class="login-box">
            ...
            <div class="user-box">
                <label>DNI:</label><br>
                <input type="text" name="dni" value="<?php echo isset($propietari['DNI']) ? $propietari['DNI'] : ''; ?>"><br>
            </div>
            <div class="user-box">
                <label>Nombre:</label><br>
                <input type="text" name="nombre" value="<?php echo isset($propietari['Nom']) ? $propietari['Nom'] : ''; ?>"><br>
            </div>
            <div class="user-box">
                <label>Dirección:</label><br>
                <input type="text" name="direccion" value="<?php echo isset($propietari['Adreça']) ? $propietari['Adreça'] : ''; ?>"><br>
            </div>
            <div class="user-box">
                <label>Teléfono:</label><br>
                <input type="text" name="telefono" value="<?php echo isset($propietari['Telf']) ? $propietari['Telf'] : ''; ?>"><br>
            </div>
            <div class="user-box">
                <label>Correo:</label><br>
                <input type="text" name="correo" value="<?php echo isset($propietari['Mail']) ? $propietari['Mail'] : ''; ?>"><br>
            </div>
